...
<%@ page import="model.AttendanceMarker" %>
<%@ page import="service.AttendanceMarkerService" %><%--
  Created by IntelliJ IDEA.
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Attendance Markers List</h2>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered first">
                                    ...
                                    <% AttendanceMarkerService service = new AttendanceMarkerService();
                                        ...
                                        ArrayList<AttendanceMarker> list=  service.viewAttendMarkers(); %>
                                    ...
                                    <tbody>
                                    <%for(AttendanceMarker i:list){ %>
                                    <tr>
                                        <td id="id"><%= i.getId() %></td>
                                        <td id="name"><%= i.getFname() %></td>
