...
@WebServlet("/SearchStudentDetailsStatusServlet")
public class SearchStudentDetailsStatusServlet extends HttpServlet{
    public SearchStudentDetailsStatusServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //SQL QUERY (RETRIEVE)
        String sql = QueryStudent.SEE_STUDENTS_BY_STATUS;
        //declare Variable
        Connection con = null;
