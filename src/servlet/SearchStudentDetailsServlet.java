...
@WebServlet("/SearchStudentDetailsDServlet")
public class SearchStudentDetailsServlet extends HttpServlet{
    public SearchStudentDetailsServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //SQL QUERY (RETRIEVE)
        String sql = QueryStudent.SEE_STUDENTS_BY_BATCH;
        //declare Variable
        Connection con = null;
